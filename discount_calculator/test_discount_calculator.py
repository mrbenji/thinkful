...
class DiscountCalculatorTests(unittest.TestCase):
    def test_zero_discounts(self):
        self.assertEqual(200.0, calculate_discount(200, 0, 0))

    def test_zero_relative_discount(self):
        self.assertEqual(90.0, calculate_discount(100, 0, 10))

    def test_zero_absolute_discount(self):
        self.assertEqual(100.0, calculate_discount(200, 50, 0))

    def test_mixed_discounts(self):
        self.assertTrue(140.0, calculate_discount(200, 25, 10))
    ...
    def test_discount_greater_than_cost(self):
        self.assertEqual(0.0, calculate_discount(212.50, 150, 0))
        self.assertEqual(0.0, calculate_discount(5, 0, 10))
